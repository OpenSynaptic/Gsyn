...
class _DashboardPageState extends ConsumerState<DashboardPage> {
  ...
  void _onMessage(DeviceMessage msg) {
    ...
    ref.read(deviceRepositoryProvider).upsertDevice(_deviceFromMessage(msg));
  ...
  Widget build(BuildContext context) {
    final onlineRate = _deviceCount > 0
        ? (_onlineCount / _deviceCount * 100)
        : 0.0;
...
SensorData _sensorDataFromReading(int aid, SensorReading r, int tsSec) =>
    SensorData(
      deviceAid: aid,
      sensorId: r.sensorId,
      unit: r.unit,
