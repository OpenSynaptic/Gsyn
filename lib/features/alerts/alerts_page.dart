...
class _AlertsPageState extends ConsumerState<AlertsPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabCtrl,
        children: [_buildList(2, l), _buildList(1, l), _buildList(0, l)],
      ),
    );
  }
        ...
        itemBuilder: (ctx, i) {
          ...
          return Card(
            child: ListTile(
              ...
              subtitle: Text(
                '${l.deviceLabel}: ${a.deviceAid} • ${DateTime.fromMillisecondsSinceEpoch(a.createdMs).toString().substring(0, 16)}',
