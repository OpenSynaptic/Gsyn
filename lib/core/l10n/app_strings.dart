...
class AppStrings {
  ...
  String deleteRuleMsg(String n) =>
      isZh ? '确定删除规则 "$n" 吗？' : 'Delete rule "$n"?';
  ...
  String get targetAidLabel =>
      isZh ? '目标设备 AID（留空 = 触发设备）' : 'Target AID (empty = trigger device)';
  String get customCmdLabel => isZh ? '自定义命令内容' : 'Custom Command';
  String generatedPayload(String p) =>
      isZh ? '生成载荷: $p' : 'Generated payload: $p';
  ...
  String get listenAddrHint =>
      isZh ? '0.0.0.0 = 所有网卡' : '0.0.0.0 = all interfaces';
  ...
  String get connSettingsSaved =>
      isZh ? '连接设置已保存' : 'Connection settings saved';
  ...
  String get btMacLabel =>
      isZh ? '蓝牙设备地址 (MAC)' : 'Bluetooth Device Address (MAC)';
  ...
  String get toggleGaugesRow1 =>
      isZh ? '温度 + 气压仪表' : 'Temperature + Pressure Gauges';
  String get toggleGaugesRow2 =>
      isZh ? '液位 + 湿度仪表' : 'Liquid Level + Humidity Gauges';
  String get secCharts => isZh ? '图表' : 'Charts';
  String get toggleBarChart =>
      isZh ? '柱状图：设备对比' : 'Bar Chart: Device Comparison';
  ...
  String get pruneDone =>
      isZh ? '已清理 7 天前历史数据' : 'Pruned data older than 7 days';
